...
- As a Guest, I should be getting one point if the numberA is the last number in the list, so that I get a point for sorting the list properly.
- As a Guest, I should be getting one point if the numberB is the last number in the list, so that I get a point for sorting the list properly.
