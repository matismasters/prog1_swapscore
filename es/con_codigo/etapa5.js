...
- Como invitado, debería obtener un punto si el número después del NúmeroA en la lista es mayor que el NúmeroA, para obtener un punto por ordenar la lista correctamente.
- Como invitado, debería obtener un punto si el número después del NúmeroB en la lista es mayor que el NúmeroB, para obtener un punto por ordenar la lista correctamente.
...
function calcularPuntaje(lista, posicionA, posicionB) {
  ...
  let puntaje = 0;
  if (valorAnteriorAPosicionA < valorEnPosicionA) {
    puntaje++;
  }
  ...
  if (valorAnteriorAPosicionB < valorEnPosicionB) {
    puntaje++;
  }
